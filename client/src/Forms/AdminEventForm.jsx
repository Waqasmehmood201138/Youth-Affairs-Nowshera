...
<div className="container-fluid bg-light">
        <div className="row custom-hight  d-flex justify-content-center align-content-center">
            <div className="col-lg-8 col-11 mb-lg-0 mb-5 bg-white text-center p-5 shadow">
                  <h4 className='fw-bold'>Enter Event Details</h4> 
                
                <form action="" className='d-flex flex-column '  onSubmit={handleSubmit} encType='multipart/form-data'>
                    <input type="text" placeholder='Enter Event Title'  className='custom-input mt-5' onChange={((e)=>setTitle(e.target.value))}/>
                    <input type="text" placeholder='Enter Description'  className='custom-input mt-5'  onChange={((e)=>setDescription(e.target.value))}/>
                    <input type="text" placeholder='Enter Event Date and Time' className='custom-input mt-5'  onChange={((e)=>setDate(e.target.value))}/>
